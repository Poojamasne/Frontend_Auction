            ...
            <div className="col-span-1">
              ...
              <input
                ...
                className={`w-full px-3 py-2 rounded-lg border ${
                  errors.siteName ? 'border-red-500' : 'border-gray-600'
...
<div className="col-span-1">
  ...
  <input
    ...
    {...register('contactEmail', {
      ...
      pattern: {
        value: /^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.(com|in|org)$/i,
      ...
      validate: {
        validDomain: (value) => {
          ...
          const validExtensions = ['.com', '.in', '.org'];
          const hasValidExtension = validExtensions.some(ext => domain.endsWith(ext));
          
          if (!hasValidExtension) {
            return 'Email domain must be .com, .in, or .org';
          }
          return true;
        }
      }
    ...
    <p className="text-red-500 text-xs mt-1">{errors.contactEmail.message}</p>
            ...
            <div className="col-span-1">
              ...
              <select
                ...
                } bg-gray-900 text-white focus:outline-none focus:ring-2 focus:ring-blue-500 hover:border-blue-400 transition`}
                {...register('currency', {
            ...
            <div className="col-span-1">
              ...
              <input
                ...
                readOnly
                value="English"
                className="w-full px-3 py-2 rounded-lg border border-gray-600 bg-gray-900 text-white cursor-not-allowed"
              />
            </div>
            ...
            <div className="col-span-1 sm:col-span-2 lg:col-span-3">
              ...
              <textarea
                rows={3}
                className={`w-full px-3 py-2 rounded-lg border ${
                  errors.siteDescription ? 'border-red-500' : 'border-gray-600'
                } bg-gray-800 text-white focus:outline-none focus:ring-2 focus:ring-blue-500`}
              ...
              {errors.siteDescription && (
                <p className="text-red-500 text-xs mt-1">{errors.siteDescription.message}</p>
              )}
            </div>
